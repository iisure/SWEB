...
<h4 style="color: rgb(193, 174, 90);"><strong>SSR服务器已启动！</strong></h4><br>
        </div>
  </div>
...
if action == "stop":
    ...
    <div class="span12">
    <div class="alert alert-block col-md-12" style="padding: 8px 35px 8px 14px; background-color: rgb(252, 248, 227); border: 1px solid rgb(251, 238, 213); ">
<h4 style="color: rgb(193, 174, 90);"><strong>SSR服务器已停止！</strong></h4><br>
        </div>
  </div>
  <div class="row-fluid"> </div>
</div>
...
if action == "restart":
    ...
    <div class="span12">
    <div class="alert alert-block col-md-12" style="padding: 8px 35px 8px 14px; background-color: rgb(252, 248, 227); border: 1px solid rgb(251, 238, 213); ">
<h4 style="color: rgb(193, 174, 90);"><strong>SSR服务器已重启！</strong></h4><br>
        </div>
  </div>
  <div class="row-fluid"> </div>
</div>
